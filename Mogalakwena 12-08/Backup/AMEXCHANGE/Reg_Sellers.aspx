<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Reg_Sellers.aspx.cs" Inherits="AMEXCHANGE.Reg_Sellers" %>
	...
	<div class="col-xs-12 col-sm-12">
		<div class="box">
			<div class="box-header">
				<div class="box-name">
					<i class="fa fa-search"></i>
					<span>SELLERS REGISTRATION</span>
				</div>
				<div class="box-icons">
			...
			<div class="box-content">
				...
				<form class="form-horizontal" role="form">
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" placeholder="Fax number" data-toggle="tooltip" data-placement="bottom" title="Tooltip for name">
						</div>
...
<div class="form-group">
                     ...
                     <div class="form-group has-success has-feedback">
						...
						<div class="col-sm-4">
							<textarea type="text" class="form-control" placeholder="Company profile" data-toggle="tooltip" data-placement="bottom" title="Tooltip for name"></textarea>
						</div>
...
<label class="col-sm-2 control-label">Tax number</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" placeholder="Tax indentification number" data-toggle="tooltip" data-placement="bottom" title="Tooltip for last name">
						</div>
                    ...
                    <label class="col-sm-2 control-label">Registration number</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" placeholder="Registration number" data-toggle="tooltip" data-placement="bottom" title="Tooltip for last name">
						</div>
                    ...
                    <div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" placeholder="Phone number" data-toggle="tooltip" data-placement="bottom" title="Tooltip for name">
						</div>
					</div>
