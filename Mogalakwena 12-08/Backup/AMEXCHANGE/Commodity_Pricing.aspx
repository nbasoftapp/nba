<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Commodity_Pricing.aspx.cs" Inherits="AMEXCHANGE.Commodity_Pricing" %>
...
<div id="main" class="container-fluid">
	...
	<div id="breadcrumb" class="col-md-12">
        ...
        <li>
					<a href="Buyers_Dashboard.aspx">AMexchange</a> </li>
			<li><a href="Commodity_Pricing.aspx">Commodity pricing</a></li>
                ...
                <div class="form-group">
                 ...
                 <label class="col-sm-2 control-label">Commodity name</label>
					 ...
					 <label class="col-sm-2 control-label">Quantity</label>
                       ...
                       <label class="col-sm-2 control-label">Reserved price</label>
                       
						<div class="col-sm-4">
							<input type="text" class="form-control" placeholder="Reserved price" data-toggle="tooltip" data-placement="bottom" title="Tooltip for last name">
						</div>                                                 
