<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Buyers_Dashboard.aspx.cs" Inherits="AMEXCHANGE.Buyers_Dashboard" %>
	...
	<div class="container-fluid expanded-panel">
		<div class="row">
			<div id="logo" class="col-xs-12 col-sm-2">
				<a href="Buyers_Dashboard.aspx"><img src="img/final logo small.jpg"/></a>
			</div>
		...
		<div class="row">
			<div class="col-xs-4">
				...
				<div class="sparkline-dashboard-info">
					<i class="fa"></i>R 756.45M
					<span class="txt-primary">Gold</span>
				</div>
			</div>
			<div class="col-xs-4">
				<div class="sparkline-dashboard" id="sparkline-2"></div>
				<div class="sparkline-dashboard-info">
					<i class="fa"></i>R 245.12M
					<span class="txt-info">Copper</span>
				</div>
			</div>
			<div class="col-xs-4">
				<div class="sparkline-dashboard" id="sparkline-3"></div>
				<div class="sparkline-dashboard-info">
					<i class="fa"></i>R 107.83M
					<span>Platinum</span>
				</div>
			</div>
		</div>
