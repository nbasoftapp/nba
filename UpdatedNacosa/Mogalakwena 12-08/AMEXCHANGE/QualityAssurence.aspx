<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QualityAssurence.aspx.cs" Inherits="AMEXCHANGE.QualityAssurance" %>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading" style="background-color: #FF8000">
                                LIST OF REGISTERED GIRLS > Quality Assurance                     
                            </div>
                        </div>
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="btn-group">
                                                                    ...
                                                                    <ul class="dropdown-menu" role="menu">
                                                                        ...
                                                                        <li>
                                                                            <asp:LinkButton ID="lnkEdit" CommandArgument='<%# Eval("ID") %>' runat="server" Style="color: #FF8000" OnClick="lnkEdit_Click">Edit</asp:LinkButton></li>
