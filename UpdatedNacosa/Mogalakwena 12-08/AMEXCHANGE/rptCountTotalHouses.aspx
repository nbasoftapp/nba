                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <table runat="server">
                                    ...
                                    <tr>
                                        <td>
                                            <asp:LinkButton ID="LinkButton5" runat="server" OnClick="LinkButton5_Click"><i class="fa fa-files-o fa-fw"></i>Number of AGYW and ABYM reached with peer education</asp:LinkButton>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:LinkButton ID="LinkButton6" runat="server" OnClick="LinkButton6_Click"><i class="fa fa-files-o fa-fw"></i>Number of AGYW and ABYM reached with homework support</asp:LinkButton>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:LinkButton ID="LinkButton7" runat="server" OnClick="LinkButton7_Click"><i class="fa fa-files-o fa-fw"></i>Number of AGYW reached with a home visit and returned to school</asp:LinkButton>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:LinkButton ID="LinkButton8" runat="server" OnClick="LinkButton8_Click"><i class="fa fa-files-o fa-fw"></i>Number of AGYW and ABYM reached with a home visit and did not return to school</asp:LinkButton>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click1"><i class="fa fa-files-o fa-fw"></i>Number of AGYW and ABYM reached with a career jamboree</asp:LinkButton>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:LinkButton ID="LinkButton9" runat="server" OnClick="LinkButton9_Click"><i class="fa fa-files-o fa-fw"></i>Number of AGYW and ABYM reached with CSE</asp:LinkButton>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:LinkButton ID="LinkButton10" runat="server" OnClick="LinkButton10_Click"><i class="fa fa-files-o fa-fw"></i>Number of AGYW and ABYM reached with the Teen Parenting programme</asp:LinkButton>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:LinkButton ID="LinkButton11" runat="server" OnClick="LinkButton11_Click"><i class="fa fa-files-o fa-fw"></i>Number of AGYW and ABYM reached with the Abangane Support Group</asp:LinkButton>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:LinkButton ID="LinkButton12" runat="server" OnClick="LinkButton12_Click"><i class="fa fa-files-o fa-fw"></i>Number of AGYW reached with PrEP demand creation</asp:LinkButton>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:LinkButton ID="LinkButton13" runat="server" OnClick="LinkButton13_Click"><i class="fa fa-files-o fa-fw"></i>Number of AGYW and ABYM reached with mental health support (individual or group setting)</asp:LinkButton>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:LinkButton ID="LinkButton14" runat="server" OnClick="LinkButton14_Click"><i class="fa fa-files-o fa-fw"></i>Number of AGYW and ABYM referred / and successfully referred to adherence support</asp:LinkButton>
                                        </td>
                                    </tr>
                                </table>
                            </div>
